...
export class EmployeeService {
  ...
  private fakeLocal: Observable<RestApiExampleResponse<Employee[]>> = of(
    {
      status : "Ok",
      data: [
    ...
    getEmployees(): Observable<Employee[]> {      
        return this.http.get<RestApiExampleResponse<Employee[]>>('https://dummy.restapiexample.com/api/v1/employees').pipe(
           map ( (response : RestApiExampleResponse<Employee[]>) => {return response.data}) );       
